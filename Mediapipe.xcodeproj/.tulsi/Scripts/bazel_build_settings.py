...
BUILD_SETTINGS = BazelBuildSettings(
    '/usr/local/Cellar/bazel/1.1.0/bin/bazel-real',
    '/private/var/tmp/_bazel_barbatosso/f07f27d557ef9457acddd1b2e9c56a44/execroot/mediapipe',
    'ios_x86_64',
    {
        'watchos_arm64_32': [
    ...
    BazelFlagsSet(
        debug = BazelFlags(
            startup = [],
            build = [
                '--override_repository=tulsi=/Users/barbatosso/Library/Application Support/Tulsi/0.20191023.88/Bazel',
